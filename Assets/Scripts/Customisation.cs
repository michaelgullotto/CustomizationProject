...
public class Customisation : MonoBehaviour
{
    ...
    // uses varables +1 and -1 in inspector to toggle through indexs of each body parts
    ...
    // grabs Textures ended up setting up in inspector due to this sometimes causing index null refrences
    private void Start()
    {
